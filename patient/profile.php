...
$stmt = $conn->prepare("SELECT u.*, p.telephone, p.date_naissance, p.sexe FROM utilisateurs u LEFT JOIN patients p ON u.id = p.user_id WHERE u.id = ?");
                ...
                <div class="dashboard-card h-100">
                    ...
                    <div class="dashboard-card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-control-static">
                                <?= htmlspecialchars($user['telephone'] ?: 'Non spécifié') ?>
                            </div>
                        </div>
                    </div>
                </div>
